...
import PasoIcon from "../../assets/PASO-Icon.svg";
                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Was möchtest du wissen?</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Du kannst mich gerne über PASO ausfragen</h2>
                            </Stack>
                        ) : (
